...
namespace DoanCN {
    ...
    public class RP_INHOADON : ReportClass {
    ...
    public class CachedRP_INHOADON : Component, ICachedReport {
        
        public CachedRP_INHOADON() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RP_INHOADON rpt = new RP_INHOADON();
            rpt.Site = this.Site;
            return rpt;
        }
